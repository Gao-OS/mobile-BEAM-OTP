...
/// Flutter plugin for embedding the Erlang/Elixir BEAM VM.
public class BeamVmPlugin: NSObject, FlutterPlugin {
...
/// Users must link liberlang.xcframework in their app.
class BeamVmBridge {
