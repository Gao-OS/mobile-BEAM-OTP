/**
 * BEAM VM Native Bridge for Flutter Plugin
 *
...
Java_io_beamvm_beam_1vm_BeamVmNative_nativeInit(
    JNIEnv *env,
    jobject thiz,
    jstring erlangPath
) {
    ...
    LOGE("Add liberlang.a to jniLibs/{ABI}/ directory");
    return -1;
#else
...
Java_io_beamvm_beam_1vm_BeamVmNative_nativeIsInitialized(
    JNIEnv *env,
    jobject thiz
) {
...
Java_io_beamvm_beam_1vm_BeamVmNative_nativeShutdown(
    JNIEnv *env,
    jobject thiz
) {
    if (g_initialized) {
...
Java_io_beamvm_beam_1vm_BeamVmNative_nativeGetOtpVersion(
    JNIEnv *env,
    jobject thiz
) {
 ...
 */
JNIEXPORT jstring JNICALL
Java_io_beamvm_beam_1vm_BeamVmNative_nativeCall(
    JNIEnv *env,
    jobject thiz,
    jstring module,
    jstring function,
 ...
 */
JNIEXPORT void JNICALL
Java_io_beamvm_beam_1vm_BeamVmNative_nativeSend(
    JNIEnv *env,
    jobject thiz,
    jstring processName,
    jstring messageJson
